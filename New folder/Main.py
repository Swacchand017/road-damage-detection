...
def Detect_Trafic():
    if filepath.get()!='':
        ...
        messagebox.showinfo(title="Select Image File", message="Select Subject")
...
btnd1 = tk.Button(master,text="Select Image File",font=("arial italic", 15), bg="#0000FF", fg="white",width=25,command=lambda:file_opener1()).grid(row=3, column=0,padx=1, pady=20)
